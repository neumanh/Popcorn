...
public class LevelSpecificationReader {
    ...
    public LevelInformation getLevelInfo(List<String> oneLevel) {
        ...
        for (Iterator<String> iterator = oneLevel.iterator(); iterator.hasNext();) {
            ...
            //pattern = Pattern.compile("block_definitions:definitions/(\\S+)"); // Level name
            matcher = pattern.matcher(line);
            if (matcher.find()) {
                blockDefinitionsFile = matcher.group(1);
                //blockDefinitionsFile = new File("resources/" + matcher.group(1));
            }
        ...
        //String updtblockDefinitionsFile = "/resources/" + blockDefinitionsFile;
